...
\newcommand \Na {\noindent\ifx\Sp\empty\rlap{\raise.2ex\hbox{\parbox{\widthof{\Large$\bigtriangleup$}}{\hfil(!)\hfil}}}\qquad\else{\raise.2ex\hbox{\makebox[\widthof{\Large$\bigtriangleup$}]{\hfil(!)\hfil}}}\quad\fi}
