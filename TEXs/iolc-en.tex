...
\def \Eqs {equalities}% (1--\arabic{index})}
\def \Wds {words}
...
\def \Nom {nominative}
% Sentences
\def \Rule {You should describe any patterns or rules that you identified in the data unless the problem explicitly instructs you otherwise.} % {Unless stated differently, describe any patterns or rules that you identified in the data.}
